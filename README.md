...
- 💻 **What I Do:** Building voice-enabled AI assistants, responsive web applications, automation utilities, and data structure solutions
...
- ⚡ **Fun Fact:** Obsessed with Jarvis-style AI voice assistants and futuristic technology
...
- 🎯 **QR Code Generator** — Fast and efficient QR code generation tool  
  [View Repository](https://github.com/Yashbuilds01/qr_generator)

- 💧 **Drink Water Reminder** — Utility for maintaining hydration reminders  
  [View Repository](https://github.com/Yashbuilds01/drink-water-reminder)

- 📋 **Todo List** — Simple task management application  
  [View Repository](https://github.com/Yashbuilds01/todo-list-python)

- 🎲 **Guess The Number** — Interactive number guessing game  
  [View Repository](https://github.com/Yashbuilds01/guess-the-number)
...
<i>⭐ From <a href="https://github.com/Yashbuilds01">Yash</a> — thanks for stopping by!</i>
